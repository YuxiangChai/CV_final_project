...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/xray.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.project.yaml', help='hyperparameters path')
